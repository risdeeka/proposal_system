            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please send password recovery email</h3>
                    </div>
				...
				<?php } ?>
                        <form role="form" id="recovery_form"  method="post" action="<?php echo site_url('sessions/lost_password'); ?>">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter Your Email Address " name="email" id="email" type="email" autofocus>
                                </div>
							...
							<a href="<?php echo site_url('sessions/login'); ?>" >Login</a>
                        </form>
                    </div>
                </div>
            </div>
